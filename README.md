[![Build Status](https://deepmultani.visualstudio.com/Deep-Project/_apis/build/status/deepsweb.python-sample-vscode-flask-tutorial?branchName=master)](https://deepmultani.visualstudio.com/Deep-Project/_build/latest?definitionId=1&branchName=master)
